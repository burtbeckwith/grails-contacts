...
<head>
	<title>Contacts Security Demo</title>
</head>

<body>

<div style="margin: 2em 1em 1.25em 2em" role='main'>
	<div class="dialog">
		...
		* As the application provides an "ACL Administration" use case, those
		...
		<g:link controller='secure'>Manage</g:link>
		<g:link controller='secure' action='debug'>Debug</g:link>
